...
function Xicon({ color, size, anim }) {
    return (
        <div className={`icon ${color ? "icon-" + color : "icon-green"} ${size && "icon-" + size} ${anim && "anim"}`}>


            <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 121.31 122.876">
